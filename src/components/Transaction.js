...
function Transaction(props){
    ...
    return (
        <tr className="transaction_row">
            <td><i className="fa fa-chevron-down icon" onClick={()=>{setCollapse(!collapse)}}></i></td>
            <td className="date_col">
                ...
                <div className ="collapsible_container" data-display={collapse}>
                    ...
                    <div className="trans_infos">Catégorie : {props.cat}<i className="fa fa-pencil"></i></div>
                    <div className="trans_infos">Notes : {props.notes}<i className="fa fa-pencil"></i></div>
                </div>
            </td>
